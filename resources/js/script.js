...
$(document).ready(function () {
    ...
    $('.js--scroll-to-plans').click(function(){
        $('html, body').animate({scrollTop: $('.js--section-plans').offset().top}, 3000); /*1000 is the time in ms */
    
    });
    
    $('.js--scroll-to-start').click(function(){
        $('html, body').animate({scrollTop: $('.js--section-features').offset().top}, 500); /*1000 is the time in ms */
    ...
    $('.js--sign-up').click(function(){
        $('html, body').animate({scrollTop: $('.js--section-sign-up').offset().top}, 2000); 
    ...
    /* Navigation scroll. Used to scroll to sections for links using # and id in the respective sections*/
